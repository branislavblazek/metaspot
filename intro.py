...
class Intro:
    ...
    def render(self):
        ...
        self.canvas.create_text(c.WIDTH//2,100, text="://metaspot",font=c.HEADING_FONT, fill='green')
        self.canvas.create_text(10,575, text="version_0.3", font=c.SMALL_FONT, fill="green", anchor="nw")
        self.canvas.create_text(c.WIDTH-300,575, text="made by: branislav", font=c.SMALL_FONT, fill="green", anchor="nw")
